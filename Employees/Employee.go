...
func main() {
	...
	company.AddEmployee("1", FullTimeEmployee{ID: 1, Name: "Askat", Salary: 10000})
	company.AddEmployee("2", PartTimeEmployee{ID: 2, Name: "Nuris", HourlyRate: 5000, HoursWorked: 20.5})
